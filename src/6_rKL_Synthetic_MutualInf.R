...
train_lscales <- readRDS("data/train_params.rds") %>% tf$constant(dtype = "float32")
val_images <- readRDS("data/val_images.rds") %>% tf$constant(dtype = "float32")
val_lscales <- readRDS("data/val_params.rds") %>% tf$constant(dtype = "float32")
test_images <- readRDS("data/test_images.rds") %>% tf$constant(dtype = "float32")
test_lscales <- readRDS("data/test_params.rds") %>% tf$constant(dtype = "float32")
